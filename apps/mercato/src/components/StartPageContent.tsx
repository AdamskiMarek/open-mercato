  ...
  return (
    <>
      <section className="rounded-lg border bg-gradient-to-br from-background to-muted/20 p-8 text-center">
        <h2 className="text-2xl font-semibold mb-3">{t('startPage.welcome.title', `Welcome to Your ${APP_BRANDING.name} Installation`, { appName: APP_BRANDING.name })}</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          {t('startPage.welcome.description', `This is a customizable start page for your fresh ${APP_BRANDING.name} installation. Choose your role below to get started and explore the features available to you.`, { appName: APP_BRANDING.name })}
        </p>
      </section>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-emerald-800/80 dark:text-emerald-200/90">
                  {t('startPage.onboarding.description', `Create a tenant, organization, and administrator account in minutes. We'll verify your email and deliver a pre-seeded environment so you can explore ${APP_BRANDING.name} with real data.`, { appName: APP_BRANDING.name })}
                </p>
              </div>
          ...
          <RoleTile
            ...
            disabledMessage={
              <>
                ...
                {t('startPage.roles.superAdmin.disabledMessage2', `Install ${APP_BRANDING.name} locally for full access via`, { appName: APP_BRANDING.name })}{' '}
                <a
